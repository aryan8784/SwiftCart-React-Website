      ...
      <div>
        <footer className=" bg-primaryColor text-ExtraDarkColor rounded-t-3xl mt-8 md:mt-0">
          <div className=" flex flex-col md:flex-row justify-between p-8 md:px-32 px-5">
            <div>
              <h1 className=" font-semibold text-3xl pb-4">SwiftCart</h1>
            ...
            <div>
              <h1 className=" font-medium text-lg pb-4 pt-5 md:pt-0">
                Company
              </h1>
              <div className=" flex flex-col gap-2">
                <Link
          ...
          <div>
            <p className=" text-center py-4">@copyright developed by <span className=" text-black">Aryan javed</span> | All rights reserved</p>
          </div>
        </footer>
      </div>
    </>
